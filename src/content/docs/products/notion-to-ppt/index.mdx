...
<div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin-top: 1.5rem; margin-bottom: 2rem;">
  <LinkButton href="https://chromewebstore.google.com/detail/pacekilednjemdghddaifncoijcfngka?utm_source=item-share-cb" icon="rocket" variant="primary" target="_blank">
